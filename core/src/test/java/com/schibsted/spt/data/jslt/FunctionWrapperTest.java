...
public class FunctionWrapperTest extends TestBase {
  ...
  public void testWrapStaticMethod() throws Exception {
    ...
    check("{}", "url-decode(\"foo\", \"utf-8\")", "\"foo\"", Collections.EMPTY_MAP, functions);
  }

  @Test
  public void testWrapStaticMethodNotFound() throws Exception {
    try {
      FunctionUtils.wrapStaticMethod("url-decode", "java.net.URLDecoder", "decooode");
  ...
  public void testWrapStaticMethodLong() throws Exception {
    Collection<Function> functions =
        Collections.singleton(
            FunctionUtils.wrapStaticMethod("time-millis", "java.lang.System", "currentTimeMillis"));
  ...
  public void testWrapStaticMethodNumeric() throws Exception {
    Collection<Function> functions =
        Collections.singleton(FunctionUtils.wrapStaticMethod("pow", "java.lang.Math", "pow"));
